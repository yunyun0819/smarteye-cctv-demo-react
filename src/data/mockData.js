export const CAMERAS = [
  { id: 1,  name: '정문 입구 01',  zone: 'ZONE-A', persons: 12, plate: '경기 33 러 4567', alert: false, color: '#00d4ff', status: 'online',      ip: '192.168.1.101', fps: 30, resolution: '4K',    cameraType: 'entrance', aiModel: '출입자 카운팅 · 안면 인식' },
  { id: 2,  name: '로비 A',        zone: 'ZONE-B', persons: 12, plate: null,              alert: false, color: '#10b981', status: 'online',      ip: '192.168.1.102', fps: 30, resolution: '1080p', cameraType: 'indoor',   aiModel: '고객 카운팅 · 혼잡도 분석' },
  { id: 3,  name: '서측 주차장',   zone: 'ZONE-C', persons: 0,  plate: '서울 88 가 1234', alert: true,  color: '#f59e0b', status: 'online',      ip: '192.168.1.103', fps: 25, resolution: '1080p', cameraType: 'parking',  aiModel: 'LPR · 블랙리스트 감지' },
  { id: 4,  name: '후문 출구',     zone: 'ZONE-D', persons: 2,  plate: '경기 22 나 9012', alert: false, color: '#8b5cf6', status: 'online',      ip: '192.168.1.104', fps: 30, resolution: '4K',    cameraType: 'entrance', aiModel: '출입자 카운팅 · LPR' },
  { id: 5,  name: '정문 입구 02',  zone: 'ZONE-A', persons: 5,  plate: null,              alert: false, color: '#00d4ff', status: 'online',      ip: '192.168.1.105', fps: 30, resolution: '1080p', cameraType: 'entrance', aiModel: '출입자 카운팅' },
  { id: 6,  name: '서버룸',        zone: 'ZONE-E', persons: 0,  plate: null,              alert: false, color: '#64748b', status: 'offline',     ip: '192.168.1.106', fps: 0,  resolution: '720p',  cameraType: 'indoor',   aiModel: '이상행동 감지 · 야간 모드' },
  { id: 7,  name: '동측 복도',     zone: 'ZONE-B', persons: 3,  plate: null,              alert: false, color: '#10b981', status: 'online',      ip: '192.168.1.107', fps: 30, resolution: '1080p', cameraType: 'indoor',   aiModel: '사람 감지 · 이상행동 감지' },
  { id: 8,  name: '지하 주차장 A', zone: 'ZONE-C', persons: 0,  plate: '서울 11 나 5678', alert: false, color: '#f59e0b', status: 'online',      ip: '192.168.1.108', fps: 25, resolution: '1080p', cameraType: 'parking',  aiModel: 'LPR · 입출차 자동기록' },
  { id: 9,  name: '지하 주차장 B', zone: 'ZONE-C', persons: 0,  plate: null,              alert: false, color: '#f59e0b', status: 'online',      ip: '192.168.1.109', fps: 25, resolution: '720p',  cameraType: 'parking',  aiModel: 'LPR' },
  { id: 10, name: '비상구 01',     zone: 'ZONE-D', persons: 0,  plate: null,              alert: false, color: '#64748b', status: 'online',      ip: '192.168.1.110', fps: 15, resolution: '720p',  cameraType: 'outdoor',  aiModel: '침입 감지' },
  { id: 11, name: '비상구 02',     zone: 'ZONE-D', persons: 0,  plate: null,              alert: false, color: '#64748b', status: 'online',      ip: '192.168.1.111', fps: 15, resolution: '720p',  cameraType: 'outdoor',  aiModel: '침입 감지' },
  { id: 12, name: '옥상',          zone: 'ZONE-E', persons: 0,  plate: null,              alert: false, color: '#64748b', status: 'maintenance', ip: '192.168.1.112', fps: 0,  resolution: '1080p', cameraType: 'outdoor',  aiModel: '야간 강화 · 침입 감지' },
  { id: 13, name: '1층 홀',        zone: 'ZONE-B', persons: 8,  plate: null,              alert: false, color: '#10b981', status: 'online',      ip: '192.168.1.113', fps: 30, resolution: '4K',    cameraType: 'indoor',   aiModel: '고객 카운팅 · 혼잡도 분석' },
  { id: 14, name: '2층 복도',      zone: 'ZONE-B', persons: 4,  plate: null,              alert: false, color: '#10b981', status: 'online',      ip: '192.168.1.114', fps: 30, resolution: '1080p', cameraType: 'indoor',   aiModel: '사람 감지' },
  { id: 15, name: '창고 01',       zone: 'ZONE-E', persons: 0,  plate: null,              alert: false, color: '#64748b', status: 'offline',     ip: '192.168.1.115', fps: 0,  resolution: '720p',  cameraType: 'indoor',   aiModel: '이상행동 감지' },
  { id: 16, name: '외부 경비초소', zone: 'ZONE-A', persons: 1,  plate: null,              alert: false, color: '#00d4ff', status: 'online',      ip: '192.168.1.116', fps: 30, resolution: '1080p', cameraType: 'outdoor',  aiModel: '야간 강화 · 배회 감지' },
]
