      ...
      <div className="cam-feed" style={{ background: gradients[index % gradients.length] }}>
        ...
        <div className="cam-bar">
          <span className="cam-time">
            Camera Stream · {new Date().toLocaleTimeString('ko-KR', { hour12: false }).slice(0, 5)}
          </span>
...
export default function Dashboard() {
  ...
  const displayCameras = cameras.slice(0, layout.count)
  const onlineCnt = cameras.filter(c => c.status === 'online').length
  const totalPersons = cameras.reduce((s, c) => s + (c.persons || 0), 0)
  ...
  return (
    <div className="content">
      <div className="kpi-row">
        <KpiCard icon={Camera}        value={`${onlineCnt} / ${cameras.length}`} label="활성 카메라"      color="#00d4ff" trend={0} />
        ...
        <section className="cam-section">
          <div className="section-header">
            <div className="section-title">
              ...
              <span className="section-badge">6 / 16 채널</span>
            </div>
